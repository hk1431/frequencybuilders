...
const SOCIAL_LINKS = [
  ...
  { label: "Twitter / X", handle: "@deepaksharma", href: "#" },
  { label: "LinkedIn", handle: "Deepak Sharma", href: "#" },
];
    ...
    <>
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to right, transparent, rgba(255,107,0,0.35) 30%, rgba(191,255,0,0.35) 70%, transparent)",
          }}
        />

        {/* Orange orb — bottom centre */}
        <div
          ...
          style={{
            ...
            height: "400px",
            background:
              "radial-gradient(ellipse, rgba(255,107,0,0.1) 0%, transparent 65%)",
            filter: "blur(80px)",
          }}
        />
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          >
            Drop your email and Deepak will reach out personally. No spam, no
            fluff — just a real conversation about where you are and where
            you&apos;re meant to be.
          </motion.p>
          ...
          >
            {submitted ? (
              ...
              >
                ✦ You&apos;re on the frequency. Deepak will be in touch.
              </div>
            ) : (
          ...
          >
            <a
              ...
              onMouseEnter={(e) => {
                ...
                el.style.background = "rgba(191,255,0,0.06)";
                el.style.boxShadow = "0 0 24px rgba(191,255,0,0.15)";
              }}
              onMouseLeave={(e) => {
                const el = e.currentTarget as HTMLElement;
          ...
          >
            {SOCIAL_LINKS.map((s) => (
              ...
              >
                <span
                  className="text-xs font-bold uppercase tracking-wider transition-colors duration-200 group-hover:text-white"
      ...
      >
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          >
            © {new Date().getFullYear()} FrequencyBuilders.com · Built by
            Deepak Sharma
          </p>
